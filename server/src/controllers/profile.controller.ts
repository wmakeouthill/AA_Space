...
export const uploadProfileImage = async (req: Request, res: Response) => {
    ...
    try {
        ...
        console.log('[PROFILE CONTROLLER] Request body:', JSON.stringify(req.body));
        ...
        console.log(`[PROFILE CONTROLLER] Perfil atualizado:`, {
            userId,
        ...
        // Log additional details to debug image paths
        console.log(`[PROFILE CONTROLLER] Image details:
        - Raw image path: ${imagePath}
        - File exists check: ${fs.existsSync(path.join(UPLOAD_DIR, path.basename(imagePath)))}
        - User ID: ${userId}
        - Contains user ID in filename: ${imagePath.includes(`${userId}_`)}
        - Complete local path: ${path.join(UPLOAD_DIR, path.basename(imagePath))}
        `);
