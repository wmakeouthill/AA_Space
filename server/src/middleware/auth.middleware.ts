...
export const authMiddleware = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        console.log(`[AUTH MIDDLEWARE] Headers Authorization: ${req.headers.authorization}`);        // Permitir acesso sem autenticação para algumas rotas públicas
        if (req.method === 'GET') {
            console.log('[AUTH MIDDLEWARE] Permitindo acesso para GET request: ' + req.url);
